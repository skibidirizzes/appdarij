...
import { SpinnerIcon, FlashcardIcon } from './icons/index.ts';
...
const WordExplorer: React.FC = () => {
    ...
    const { user: { settings }, addInfoToast, setWordToAddToDeck } = useContext(UserContext);
            ...
            {activeWord && (
                <Card className="p-6 animate-fade-in card-lift-hover">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex gap-2">
                           <Button onClick={() => setWordToAddToDeck(activeWord)} size="sm" className="!p-2.5 bg-slate-600 hover:bg-slate-500">
